package com.example.demo_diplom.rest.configuration;
...
@Configuration
@ComponentScan(basePackages = "com.example.demo_diplom.rest")    //пакет для скана на бины
...
public class MyConfig {
    ...
    public DataSource dataSource() {
        ...
        try
        {
            ...
            dataSource.setJdbcUrl("jdbc:mysql://localhost:3306/poisk_database?useSSL=false&serverTimezone=UTC");
            dataSource.setUser("root");
            dataSource.setPassword("39713971");
        }
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.example.demo_diplom.rest.entity");
